...
CREATE TABLE IF NOT EXISTS `wall`.`comments` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_comments_messages1_idx` (`message_id` ASC, `message_user_id` ASC),
  INDEX `fk_comments_users1_idx` (`users_id` ASC),
  CONSTRAINT `fk_comments_messages1`
    FOREIGN KEY (`message_id` , `message_user_id`)
    REFERENCES `wall`.`messages` (`id` , `user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
